        ...
        <div className="content-wrapper">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div variants={fadeUp} initial="hidden" animate="visible">
              ...
              >
                The Gap Between Where You Are and Where You Want to Be Is
                Usually Technical. Let&apos;s Close It.
              </h1>
              <p
                className="text-lg"
                style={{ color: "var(--color-text-secondary)" }}
              >
                Whether you&apos;re sitting on untapped data, stalled in a
                build, or looking for a senior partner to take your technology
                to the next level — this is where that conversation starts.
              </p>
            </motion.div>
            ...
            >
              <div>
                ...
                <p
                  ...
                  style={{ color: "var(--color-text-secondary)" }}
                >
                  I&apos;ll listen to what you&apos;re building, ask the right
                  questions, and give you my honest, direct assessment of the
                  best path forward. If we&apos;re a great fit, we&apos;ll move
                  fast. If I&apos;m not the right solution, I&apos;ll tell you
                  that too.
                  <br />
                  <br />
