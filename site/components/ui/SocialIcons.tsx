// Custom social icon components — inline SVGs for brand accuracy
// Using Lucide for icons that don't have brand equivalents
...
export function YouTubeIcon({ size = 20, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function MediumIcon({ size = 20, className, style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
